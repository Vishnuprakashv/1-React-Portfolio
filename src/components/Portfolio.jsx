...
import PORTFOLIO_02 from "./My_Document/image/portfolio_02.webp"
        ...
        <div className={style.portfolio_box}>
          <div className={style.portfolio_content_box}>
            ...
            <div className={style.button_box}>
              <button id={style.btn_01}><a href="https://github.com/Vishnuprakashv/Calculator01">Github</a></button>
            </div>
          </div>
          <div className={style.portfolio_content_box}>
            <div  className={style.portfolio_img_box}>
          ...
          <div className={style.portfolio_content_box}>
            ...
            <div className={style.button_box}>
              <button id={style.btn_01}><a href="https://github.com/Vishnuprakashv/-2_Django">Github</a></button>
          ...
          <div className={style.portfolio_content_box}>
            ...
            <div className={style.button_box}>
              <button id={style.btn_01}><a href="https://github.com/Vishnuprakashv/-1_Blender">Github</a></button>
          ...
          <div className={style.portfolio_content_box}>
             ...
             <div className={style.button_box}>
              <button id={style.btn_01}><a href="https://github.com/Vishnuprakashv/-2_Blender">Github</a></button>
          ...
          <div className={style.portfolio_content_box}>
            ...
            <div className={style.button_box}>
              <button id={style.btn_01}><a href="https://github.com/Vishnuprakashv/PaytmClone-project">Git Hub</a></button>
